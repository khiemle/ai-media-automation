...
class YoutubeVideo(Base):
    ...
    spectrum_bar_count:       Mapped[int]       = mapped_column(Integer,     nullable=False, default=50,         server_default="50")
    spectrum_align_horizontal: Mapped[str]      = mapped_column(String(10),  nullable=False, default="center",   server_default="center")
    spectrum_align_vertical:  Mapped[str]       = mapped_column(String(10),  nullable=False, default="bottom",   server_default="bottom")
